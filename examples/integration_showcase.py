#!/usr/bin/env python3
"""
Integration showcase (v0.4.1). Prints copy-paste snippets and runs one live demo.
"""
...
print("=" * 80)
print("PRIVYSHA INTEGRATION SHOWCASE (v0.4.1)")
print("=" * 80)
...
print('add_privysha_middleware(app, privacy=True)  # maps to mode="balanced"')

# 3. Flask / Django
print("\n\n3. Flask / Django")
print("-" * 60)
print("from privysha.integrations.flask import PrivySHAMiddleware")
print("PrivySHAMiddleware(app)")
print("# Django: add privysha.integrations.django.middleware.PrivySHAMiddleware")
...
print("-" * 60)
print("from privysha.integrations.composition_strategy import compose_with_instructor")
...
rows = [
    ...
    ("FastAPI middleware", "30s", "add_privysha_middleware(app)"),
